const five_by_five = (() => {
    ...
    const samples: ReadonlyArray<ReadonlyArray<Input>> = [
        [
            ["board", { orange: false }],
    ...
    function line(o: { style: Style, dir: Direction, gap?: boolean }) {
        if (!o.gap) {
            ...
            return get_path(o.style, {
                右: "m20.709 8.9391h-2.2023",
                左: "m2.929 8.9391h-2.2023",
                下: "m8.934 14.815v2.2023",
                上: "m8.934 -2.965v2.2023",
                左上: "m2.809  2.875 -1.9788-1.9788",
                右下: "m20.599 20.665-1.9788-1.9788",
                左下: "m2.809  15.135-1.9788 1.9788",
                右上: "m20.599 -2.655-1.9788 1.9788"
            }[o.dir]);
        }
    }
    ...
    function get_path(style: Style, d: string) {
        const path = document.createElementNS('http://www.w3.org/2000/svg', "path");
    ...
    function append(result: HTMLElement, i: Input) {
        if (i[0] === "board") {
            ...
            const _never: never = i[0];
            throw new Error(_never);
        }
    }

    function gen_svg(input: ReadonlyArray<Input>, result: HTMLElement) {
        result.innerHTML = "";
