...
function piece(color, profession, column, row, degree) {
    ...
    g.setAttributeNS('http://www.w3.org/2000/svg', 'transform', `translate(${LEFT * 17.55} ${TOP * 17.55}) rotate(${degree} ${(GLOBAL_OFFSET_TABLE[profession][0].x + GLOBAL_OFFSET_TABLE[profession][180].x) / 2} ${(GLOBAL_OFFSET_TABLE[profession][0].y + GLOBAL_OFFSET_TABLE[profession][180].y) / 2})`);
